...
rule paraphase_merge_and_copy_vcf:
    ...
    shell:
        ...
        bcftools concat -a -O v {params.variant_files} | bcftools annotate --header-lines {input.vcf_header} | bcftools sort -Oz -o {output.merged_vcf} &> {log};
        ...
        #  bcftools concat -a -O v {params.variant_files} | bcftools annotate --header {input.vcf_header} | bcftools sort -Oz -o {output.merged_vcf} &> {log};
        #
        #
